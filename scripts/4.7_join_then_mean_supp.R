...
#The purpose of this script is to join SIF and PAR data BEFORE taking the 16-day mean, rather than after, to make sure data processing approach doesn't affect overall seasonal trajectory. (For use in Figure S1)
