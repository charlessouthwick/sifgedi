...
datadir <- "/Users/charlessouthwick/Documents/PhD/sifgedi/oco3_data_2024thru2025"
...
write.csv(sif_df_c, paste0(final_dir, "/oco3_df_complete_2024thru2025.csv"), row.names = FALSE)



########
## Summarize for use in supplemental analysis -------------------------------------
...
write.csv(df_summ, paste0(final_dir, "/oco3_summ_2024thru2025.csv"), row.names = FALSE)
write.csv(df_georeg_summ, paste0(final_dir, "/oco3_georeg_summ_2024thru2025.csv"), row.names = FALSE)

write.csv(df_yr_summ, paste0(final_dir, "/oco3_yr_summ_2024thru2025.csv"), row.names = FALSE)
write.csv(df_yr_georeg_summ, paste0(final_dir, "/oco3_yr_georeg_summ_2024thru2025.csv"), row.names = FALSE)
