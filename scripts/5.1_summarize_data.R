...
#Select variables
gedi_df <- gedi_proc %>%
  select(c(doymin, monthday, truedate, year, x, y, pai, pai_mean, pai_us, pai_toc, meanpavd, sdvfp, subregion, zone, georeg, georeg_agg, iprec, iprec_sd, prec, cwd, vpd, ndvi, nirv, nirvp, pri_nar, cci, apar, fpar, modis_lai, sif743_cor, sif_par, sif_apar, phif, ndvi_tropo, nirv_tropo_refl, nirv_tropo_rad, nirvp_tropo_refl, nirvp_tropo_rad, fesc, fesc_tropo_refl, fesc_tropo_rad, sif_rel_tropo, phif_tropo_refl, phif_tropo_rad, number_of_hits))
...
vars_noyr <- c("pai", "pai_toc", "pai_us", "modis_lai", "meanpavd", "sdvfp", 
               "nirv", "nirvp", "fpar", "apar", "sif743_cor", "sif_par", "sif_apar", "phif", "fesc", "pri_nar", "cci", "sif_rel_tropo", "ndvi_tropo", "nirv_tropo_refl", "nirv_tropo_rad", "nirvp_tropo_refl", "nirvp_tropo_rad", "phif_tropo_refl", "phif_tropo_rad", "fesc_tropo_refl", "fesc_tropo_rad", "iprec", "cwd", "vpd", "doymin")  # includes doymin
vars_yr <- c("pai", "pai_toc", "pai_us", "modis_lai", "meanpavd", "sdvfp", 
             "nirv", "nirvp", "fpar", "apar", "sif743_cor", "sif_par", "sif_apar", "phif", "fesc", "pri_nar", "cci", "sif_rel_tropo", "ndvi_tropo", "nirv_tropo_refl", "nirv_tropo_rad", "nirvp_tropo_refl", "nirvp_tropo_rad", "phif_tropo_refl", "phif_tropo_rad", "fesc_tropo_refl", "fesc_tropo_rad", "iprec", "cwd", "vpd") #does not include doymin
