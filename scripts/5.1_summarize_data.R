...
vars_noyr <- c("pai", "pai_toc", "pai_us", "modis_lai", "meanpavd", "sdvfp", 
               "nirv", "nirvp", "fpar", "apar", "sif743", "sif743_cor", "sifcor_csza", "sif_par", "sif_apar", "sifc_par", "sifc_apar", "phif", "fesc", "pri_nar", "cci", "sif_rel_tropo", "sifc_rel_tropoc", "ndvi_tropo", "nirv_tropo_refl", "nirv_tropo_rad", "nirv_tropoc_rad", "nirvp_tropo_refl", "nirvp_tropo_rad", "phif_tropo_refl", "phif_tropo_rad", "fesc_tropo_refl", "fesc_tropo_rad", "iprec", "cwd", "vpd", "doymin")  # includes doymin
vars_yr <- c("pai", "pai_toc", "pai_us", "modis_lai", "meanpavd", "sdvfp", 
             "nirv", "nirvp", "fpar", "apar", "sif743", "sif743_cor", "sifcor_csza", "sif_par", "sif_apar", "sifc_par", "sifc_apar", "phif", "fesc", "pri_nar", "cci", "sif_rel_tropo", "sifc_rel_tropoc", "ndvi_tropo", "nirv_tropo_refl", "nirv_tropo_rad", "nirv_tropoc_rad", "nirvp_tropo_refl", "nirvp_tropo_rad", "phif_tropo_refl", "phif_tropo_rad", "fesc_tropo_refl", "fesc_tropo_rad", "iprec", "cwd", "vpd") #does not include doymin
